...
from .json_types import json_object, text_value
...
from .web_runtime import test_client_factory
...
if TYPE_CHECKING:
    ...
    from .web_runtime import TestClient
...
def bootstrap_policy_client(root: Path, *, allow_monitored_domains: bool) -> PolicyClient:
    ...
    client = test_client_factory(create_registry_app(settings))
