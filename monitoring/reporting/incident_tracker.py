...
class Incident:
    ...
    def add_update(self, update_type: str, message: str, author: str | None = None):
    ...
    def set_status(self, status: str, author: str | None = None):
...
class IncidentTracker:
    ...
    def load_incident(self, incident_id: str) -> Incident | None:
