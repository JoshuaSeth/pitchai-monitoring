...
TRUST_DIGEST_ASSIGNMENT = re.compile(
    r'^(?P<prefix>\s*expected_(?P<kind>verifier|baseline)_sha256=")'
    r'(?P<digest>[0-9a-f]{64})(?P<suffix>"\s*)$',
    re.MULTILINE,
)
EXPECTED_GATES = (
...
EXPECTED_NORMALIZED_STRICT_WORKFLOW_SHA256 = "757c337cdaa05167e2aa7cd4c1878513c3236169d83326b2b15074c05c9735b8"
RUFF_ARGUMENTS = (
    "check",
    "--no-cache",
    "--ignore-noqa",
